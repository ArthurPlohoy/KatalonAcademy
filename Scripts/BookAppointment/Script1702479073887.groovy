...
WebUI.click(findTestObject('Page_CURA Healthcare Service/input_programs_1'))
...
WebUI.setText(findTestObject('Page_CURA Healthcare Service/textarea_comment'), 'test')
...
WebUI.rightClick(findTestObject('Page_CURA Healthcare Service/h2_Appointment Confirmation'))
