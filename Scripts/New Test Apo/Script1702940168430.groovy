...
WebUI.doubleClick(findTestObject('Page_CURA Healthcare Service/input_form-control_1'))
...
WebUI.setText(findTestObject('Page_CURA Healthcare Service/textarea_comment'), 'Test 123')
