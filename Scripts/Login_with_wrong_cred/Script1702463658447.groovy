...
WebUI.setText(findTestObject('Page_CURA Healthcare Service/input_username'), 'test')

WebUI.setEncryptedText(findTestObject('Page_CURA Healthcare Service/input_password'), 'P9ET2sDE0SE=')
